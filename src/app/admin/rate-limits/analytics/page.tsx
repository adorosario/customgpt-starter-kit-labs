...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-8">
                  ...
                  <tr key={i} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                        user.blocked > 0 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                      }`}>
                        {user.blocked}
                      </span>
                    </td>
      ...
      {/* Modern summary stats card */}
      {/* <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">Summary Statistics</h3>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-gray-900">{blockRate}%</div>
            <div className="text-sm font-medium text-gray-600 mt-1">Block Rate</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gray-900">
              {(data.overview.totalRequests / 24).toFixed(0)}
            </div>
            <div className="text-sm font-medium text-gray-600 mt-1">Requests/Hour</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gray-900">
              {(data.overview.uniqueUsers / 24).toFixed(0)}
            </div>
            <div className="text-sm font-medium text-gray-600 mt-1">Users/Hour</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gray-900">99.2%</div>
            <div className="text-sm font-medium text-gray-600 mt-1">Success Rate</div>
          </div>
        </div>
      </div> */}
    </div>
